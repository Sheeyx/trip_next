...
export const GET_WAIT_NOTIFICATION_COUNT = gql`
  query GetWaitNotificationCount($notificationId: String!) {
    getWaitNotificationCount(notificationId: $notificationId)
  }
`;
